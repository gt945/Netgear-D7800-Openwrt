...
#include "athrs17_phy.h"
    ...
    defined(CONFIG_HW29764881P0P128P256P4X4P4X4)
#include "../../../drivers/net/ipq/ipq_gmac.h"
#endif
#if defined(CONFIG_HW29764958P0P128P256P3X3P4X4)
#include "../../../drivers/net/ipq/ipq_gmac_hw29764958p0p128p256p3x3p4x4.h"
#endif
#if defined(CONFIG_HW29764958P0P128P512P3X3P4X4)
#include "../../../drivers/net/ipq/ipq_gmac_hw29764958p0p128p512p3x3p4x4.h"
#endif
#if defined(CONFIG_HW29764958P0P128P256P4X4P4X4PXDSL)
#include "../../../drivers/net/ipq/ipq_gmac_hw29764958p0p128p256p4x4p4x4pxDSL.h"
#endif
...
void athrs17_reset_switch(void)
{
    ...
    defined(CONFIG_HW29764958P0P128P256P4X4P4X4PXDSL) || \
