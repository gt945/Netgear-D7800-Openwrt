...
#define DNI_NAND
#define CONFIG_HW29764841P0P128P256P3X3P4X4
...
#define CONFIG_SYS_IMAGE_LEN   0x1a00000
#define CONFIG_SYS_IMAGE_BASE_ADDR 0x1340000
...
#define CONFIG_SYS_FLASH_CONFIG_PARTITION_NAME	   "config"
#define CONFIG_SYS_FLASH_CONFIG_PARTITION_SIZE     0x1f000  /* 1 UBI LEB */
#define CONFIG_SYS_STRING_TABLE_LEN                0x1f000  /* Each string table takes 1 UBI LEB to save */
#define CONFIG_SYS_STRING_TABLE_NUMBER 10
#define CONFIG_SYS_STRING_TABLE_TOTAL_LEN          0x136000  /* Totally allocate 10 UBI LEBs to save all string tables */
#define CONFIG_SYS_STRING_TABLE_PARTITION_NAME     "language"
#define CONFIG_RESERVED_LEN  0  /* blocked by "netgear" partition */
#endif

#define MTDIDS_DEFAULT    "nand0=msm_nand"
#define MTDPARTS_DEFAULT  "mtdparts=msm_nand:12M@0x2d40000(netgear)"
...
#ifndef __ASSEMBLY__
#include <compiler.h>
#include "../../board/qcom/hw29764841p0p128p256p3x3p4x4/ipq806x_cdp.h"
...
#define CONFIG_BOOTCOMMAND  "sleep 2;   nmrp;  " \
                            "if loadn_dniimg 0 0x1340000 0x44000000 && " \
...
#define WIFI_5G_LED_GPIO	67  /* WLAN 5G LED, unknown (Output Pin/Active HIGH) */
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"imgaddr=0x41000000 && source $imgaddr:script\0"	\
	"ubi_prepare=mtdparts default; ubi part || ubi part netgear \0"	\
	""
