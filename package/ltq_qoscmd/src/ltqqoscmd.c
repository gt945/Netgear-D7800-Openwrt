...
static void ppa_print_init_fake_cmd(PPA_CMD_DATA *pdata)
{
    ...
    {
        IFX_PPACMD_PRINT("ltqqoscmd control to enable lan/wan failed\n");
        return ;
    }
}
...
static int ppa_parse_control_cmd(PPA_CMD_OPTS *popts,PPA_CMD_DATA *pdata)
{
    ...
    if (wan_opt ==0 &&  lan_opt == 0) /*sgh add: without this checking, all lan/wan acceleration will be disabled if user run command "ltqqoscmd control" without any parameter */
        return PPA_CMD_ERR;
...
static int ppa_parse_del_session_cmd(PPA_CMD_OPTS *popts, PPA_CMD_DATA *pdata)
{
    ...
    if( ip1_type == IP_VALID_V6 )
    {
        IFX_PPACMD_PRINT("ltqqoscmd not support IPV6. Pls recompile ltqqoscmd\n");
        return PPA_CMD_ERR;
    }
#endif
...
/*ltqqoscmd setbr: set bridge mac address learning hook enable/disable---begin*/
...
/*ltqqoscmd setbr: set bridge mac address learning hook enable/disable ---end*/

/*ltqqoscmd getbrstatus: get bridge mac address learning hook status: enabled/disabled---begin*/
...
int get_portid(char *ifname)
{
    ...
    {
        IFX_PPACMD_PRINT("ltqqoscmd get portid failed\n");
        return -1;
    }
...
/*ltqqoscmd ppa_get_br_status_cmd:   ---end*/
...
/*ltqqoscmd getqnum: get eth1 queue number  ---begin*/
...
/*ltqqoscmd getqnum: get eth1 queue number  ---end*/


/*ltqqoscmd getmib: get qos mib counter  ---begin*/
...
/*ltqqoscmd getqmib: get eth1 queue number  ---end*/

#ifdef CONFIG_LTQ_PPA_QOS_WFQ
/*ltqqoscmd setctrlwfq ---begin*/
...
/*ltqqoscmd setctrlwfq ---end*/

/*ltqqoscmd getctrlwfq ---begin*/
...
/*ltqqoscmd getctrlwfq ---end*/



/*ltqqoscmd setwfq ---begin*/
...
/*ltqqoscmd setwfq ---end*/

/*ltqqoscmd resetwfq ---begin*/
...
/*ltqqoscmd resetwfq ---end*/

/*ltqqoscmd getwfq ---begin*/
...
/*ltqqoscmd setctrlrate ---end*/

/*ltqqoscmd getctrlrate ---begin*/
...
/*ltqqoscmd getctrlrate ---end*/

/*ltqqoscmd setrate ---begin*/
...
/*ltqqoscmd setrate ---end*/

/*ltqqoscmd resetrate ---begin*/
...
/*ltqqoscmd resetrate ---end*/

/*ltqqoscmd getrate ---begin*/
...
/*ltqqoscmd gethook: get all exported hook number  ---begin*/
...
/*ltqqoscmd gethook: get all exported hook number  ---end*/

/*ltqqoscmd gethooklist: get all exported hook list  ---begin*/
...
/*ltqqoscmd gethooklist: get all exported hook list  ---end*/

/*ltqqoscmd sethook: set hook to enable/dsiable  ---begin*/
...
/*ltqqoscmd sethook: set hook to enable/dsiable  ---end*/

/*ltqqoscmd r ( getmem ) ---begin*/
...
/*ltqqoscmd r ( getmem ) ---end*/

/*ltqqoscmd w ( setmem ) ---begin*/
...
/*ltqqoscmd w ( setmem ) ---end*/


/*ltqqoscmd sethaldbg (  ) ---begin*/
...
/*ltqqoscmd sethaldbg ---end*/

#if defined(CONFIG_LTQ_PPA_MFE) && CONFIG_LTQ_PPA_MFE

/*ltqqoscmd controlmf: enable multiple field  ---begin*/
...
/*ltqqoscmd controlmf: enable multiple field  ---end*/

/*ltqqoscmd getmf: get multiple field status: enabled/disabled ---begin*/
...
/*ltqqoscmd getmf: get multiple field status: enabled/disabled --end*/


/*ltqqoscmd getmfnum: get max multiple field flow number: ---------------------------------begin*/
...
/*ltqqoscmd getmfnum: get max multiple field flow number: ---------------------------------end*/
...
/*ltqqoscmd addmfflow: add a multiple field flow   --------------------------------------------------begin*/
...
/*ltqqoscmd addmfflow: enable multiple field  ---end*/

/*ltqqoscmd gettmfflow: get all multiple field flow information ------------------------------------------begin*/
...
/*ltqqoscmd getmfflow: enable multiple field  ---end*/

/*ltqqoscmd delmfflow: delete one multiple field flow information------------------------------------------begin*/
static void ppa_del_mf_flow_help( int summary)
{
    ppa_mf_flow_help("delmf", summary);
    return;
}
/*ltqqoscmd delmfflowindex: delete all multiple field flow information via index------------------------------------------begin*/
...
/*ltqqoscmd delmfflowindex: enable multiple field  ---end*/
#endif

/*ltqqoscmd ppa_get_portid ---begin */
...
/*ltqqoscmd ppa_get_portid ---end */


/*ltqqoscmd ppa_get_dsl_mib ---begin */
...
/*ltqqoscmd ppa_clear_dsl_mib ---begin */
...
/*ltqqoscmd ppa_clear_port_mib ---begin */
...
/*ltqqoscmd d( dbgtool ) ---end*/


/*ltqqoscmd ppa_set_value ---begin */
...
/*ltqqoscmd ppa_set_value ---end */

/*ltqqoscmd setppefp ---begin*/
...
/*ltqqoscmd setppefp ---end*/

#ifdef CONFIG_LTQ_PPA_API_SW_FASTPATH
/*ltqqoscmd setswfp ---begin*/
...
*/
    {
        ...
        NULL /* ppa_get_lan_session_count_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_get_lan_sessions_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_get_wan_session_count_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_get_wan_sessions_help*/,
        ppa_parse_get_session_cmd,
    ...
    },
    {
        ...
        NULL /* ppa_get_session_timer_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_set_session_timer_help*/,
...
*/
    {
        ...
        NULL /* ppa_get_session_criteria_help*/,
...
*/
    ...
    },
    {
        ...
        NULL /* ppa_get_vfilter_count_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_get_all_vlan_filter_help*/,
        ppa_parse_simple_cmd,
...
*/

    {
        ...
        NULL /* ppa_get_wan_mii0_vlan_range_count_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_add_wan_mii0_vlan_range_help*/,
    ...
    },
    {
        ...
        NULL /* ppa_get_wan_mii0_all_vlan_range_help*/,
        ppa_parse_simple_cmd,
...
#ifdef CONFIG_LTQ_PPA_QOS
    {
        "---QOS related commands for vrx320",
        PPA_CMD_INIT,
        NULL,
        NULL,
        NULL,
...
*/
...

    {
        ...
        NULL /* ppa_del_mf_flow_index_help*/,
...
*/
    ...
    },
    {
        "setvalue",  // set value
        PPA_CMD_SET_VALUE,
        NULL /* ppa_set_variable_value_help*/,
    ...
    },
    {
        "getvalue",  // get value
        PPA_CMD_GET_VALUE,
        NULL /* ppa_get_variable_value_help*/,
...
#if PPACMD_DEBUG
    IFX_PPACMD_PRINT("\n");
    /* IFX_PPACMD_PRINT("* Note: Create a file %s will enable ltqqoscmd debug mode\n", debug_enable_file ); */
    IFX_PPACMD_PRINT("* Note: Any number inputs will be regarded as decial value without prefix 0x\n");
    IFX_PPACMD_PRINT("* Note: Please run \"ltqqoscmd <command name> -h\" to get its detail usage\n");
    IFX_PPACMD_PRINT("\n");
#endif
