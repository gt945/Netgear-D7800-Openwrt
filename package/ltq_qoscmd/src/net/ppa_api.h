...
#define ENUM_STRING(x)   #x
  ...
  int32_t ppa_bridge_entry_add(uint8_t *, PPA_NETIF *, uint32_t);
  int32_t ppa_bridge_entry_delete(uint8_t *, uint32_t);
  int32_t ppa_bridge_entry_hit_time(uint8_t *, uint32_t *);
  int32_t ppa_bridge_entry_inactivity_status(uint8_t *);
  int32_t ppa_set_bridge_entry_timeout(uint8_t *, uint32_t);
